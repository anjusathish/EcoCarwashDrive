//
//  UserSettingServiceHelper.swift
...
class UserSettingServiceHelper {
    
    class func request<T: Codable>(router: UserSettingServiceManager, completion: @escaping (Result<T, CustomError>) -> ()) {
