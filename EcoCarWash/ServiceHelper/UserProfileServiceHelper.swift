...
class UserProfileServiceHelper {
    ...
    class func request<T: Codable>(router: UserProfileServiceManager, completion: @escaping (Result<T, CustomError>) -> ()) {
    ...
    class func requestFormData<T: Codable>(router: UserProfileServiceManager, completion: @escaping (Result<T, CustomError>) -> ()) {
